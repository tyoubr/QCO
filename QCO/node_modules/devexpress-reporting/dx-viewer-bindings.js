...
addToBindingsCache('text: model.headerText', function ($context, $element) { return { 'text': function () { return $context.$data.model.headerText; } }; });
...
addToBindingsCache('dxButton: model.resetButton', function ($context, $element) { return { 'dxButton': function () { return $context.$data.model.resetButton; } }; });
addToBindingsCache('dxButton: model.submitButton', function ($context, $element) { return { 'dxButton': function () { return $context.$data.model.submitButton; } }; });
addToBindingsCache('dxSelectBox: { dataSource: widget.dataSource, onValueChanged: widget.onValueChanged, value: widget.value, opened: widget.opened, displayExpr: widget.displayExpr, useItemTextAsTitle: true, onKeyUp: widget.onKeyUp, itemTemplate: widget.itemTemplate, searchMode: widget.searchMode, searchEnabled: widget.searchEnabled, searchTimeout: widget.searchTimeout, disabled: widget.disabled, dropDownOptions: { container: getPopupContainer($element), wrapperAttr: widget.wrapperAttr, }, tabIndex: \'-1\', inputAttr: widget.inputAttr }', function ($context, $element) { return { 'dxSelectBox': function () { return { 'dataSource': $context.$data.widget.dataSource, 'onValueChanged': $context.$data.widget.onValueChanged, 'value': $context.$data.widget.value, 'opened': $context.$data.widget.opened, 'displayExpr': $context.$data.widget.displayExpr, 'useItemTextAsTitle': true, 'onKeyUp': $context.$data.widget.onKeyUp, 'itemTemplate': $context.$data.widget.itemTemplate, 'searchMode': $context.$data.widget.searchMode, 'searchEnabled': $context.$data.widget.searchEnabled, 'searchTimeout': $context.$data.widget.searchTimeout, 'disabled': $context.$data.widget.disabled, 'dropDownOptions': { 'container': $context.$data.getPopupContainer($element), 'wrapperAttr': $context.$data.widget.wrapperAttr }, 'tabIndex': '-1', 'inputAttr': $context.$data.widget.inputAttr }; } }; });
...
addToBindingsCache('cacheElement: { action: cacheElement }, dxEllipsisEditor: { value: displayValue, readOnly:true, inputAttr: { \'aria-label\': $parent.displayName, id: _editorInputId }, openOnFieldClick: true, buttonAction: function() { showPopup(); } }', function ($context, $element) { return { 'cacheElement': function () { return { 'action': $context.$data.cacheElement }; }, 'dxEllipsisEditor': function () { return { 'value': $context.$data.displayValue, 'readOnly': true, 'inputAttr': { 'aria-label': $context.$parent.displayName, 'id': $context.$data._editorInputId }, 'openOnFieldClick': true, 'buttonAction': function () { $context.$data.showPopup(); } }; } }; });
