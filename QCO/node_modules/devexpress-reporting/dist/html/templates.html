...
<script type="text/html" id="dxrd-right-panel-template-base">
    <div class="dx-shadow dx-shadow-right dxd-border-secondary dxrd-tab-panel-wrapper" data-bind="styleunit: { width: width }, css: class, dxMutationObserver: keyboardHelper">
        <div class="dxrd-right-tabs dxd-side-panel-tabs-back-color dxd-back-contrast" data-bind="css: tabsElement.class">
            ...
            <div role="button" class="dxrd-tab-item dx-accessibility-rightpanel-button dxd-side-panel-tab-back-color dxd-back-highlighted dx-accessibility-focus-border-accented" data-bind="dxAction: { action: function(s) { $data.click(); }}, css: css.class, attr: { title: text, 'aria-label': text, 'aria-expanded': active }, visible: visible">
...
<script type="text/html" id="dx-treelist-header-item">
    ...
    attr: attr">
        ...
        <div class="dx-treelist-caption" data-bind="style: { 'padding-left': hasItems ? '0px': '18px' }">
            ...
            <!-- /ko  -->
            <!-- ko if: isDraggable -->
            <div class="dx-treelist-selectedcontent" data-bind="click: function(s, e) { $root.hideContextMenu && $root.hideContextMenu(); toggleSelected(s, e); }, event: $root.ContextMenusEnabled && $root.ContextMenusEnabled() ? { contextmenu: toggleSelected } : null, draggable: dragDropHandler">
                <!-- ko template: templates.headerItemContent -->
                <!-- /ko -->
            </div>
            <!-- /ko -->
            <!-- ko ifnot: isDraggable -->
            <div class="dx-treelist-selectedcontent" data-bind="click: function(s, e) { $root.hideContextMenu && $root.hideContextMenu(); toggleSelected(s, e); }, event: $root.ContextMenusEnabled && $root.ContextMenusEnabled() ? { contextmenu: toggleSelected } : null">
                <!-- ko template: templates.headerItemContent -->
                <!-- /ko -->
            </div>
            <!-- /ko -->
...
﻿<script type="text/html" id="dxrv-preview-date-range-mobile">
    ...
    <div class="dxrdp-content" data-bind="dxclick: clickToBrick, styleunit: { width: width, height: height }, autoFit: autoFitOptions">
        ...
        <img class="dxrd-width-100 dxrd-height-100" data-bind="attr: { src: displayImageSrc }, style:{ 'background-color': color }" />
    ...
    <div class="dxrd-preview-export-toolbar-item dxrd-toolbar-item" data-bind="visible: visible">
        <div class="dx-accessibility-toolbar-item dx-accessibility-focus-border-accented">
            <div class="dxrd-preview-export-to dxd-button-back-color dxd-state-normal dxd-icon-highlighted" 
                ...
                <div class="dxrd-preview-export-menu-item" data-options="dxTemplate: { name: 'item' }" data-bind="attr: { title: text }">
                    <!--ko if: $data.format -->
...
<script type="text/html" id="dxrd-preview-page">
    <div role="img" class="dxrd-report-preview-content dxrd-position-relative dxrd-width-100 dxrd-height-100"  data-bind="attr: {'aria-label': currentPageAriaLabelImgAlt }, dxclick: clickToBrick, 'brick-selection-prog': brickSelectionProg">
        ...
        <div>
            <img class="dxrd-pointer-events-none dxrd-width-100 dxrd-height-100" data-bind="attr: { src: displayImageSrc, 'alt': currentPageAriaLabelImgAlt }" />
            <!-- ko foreach: activeBricks -->
...
<div class="breadcrumbs-wrapper">
    ...
    <a class="breadcrump-link breadcrumb-item dxd-text-accented" data-bind="click: function(s, e) { $parent.onClick($data.position); }">
        <span data-bind="text: $data.displayText"></span>
    </a>
    <span class="breadcrumb-item-seperator" data-bind="template: { name: 'dxrd-svg-preview-breadcrumbs_seperator' }">
    </span>
    <!-- /ko -->
    <!-- ko if: $index() === ($parent.listItems.length - 1) -->
    <div class="breadcrumb-item dxd-text-primary">
        <span data-bind="text: $data.displayText"></span>
    </div>
    <!-- /ko -->
...
<script type="text/html" id="dxrd-preview-search">
    <div role="search" aria-haspopup="listbox" class="dxrd-preview-search-wrapper" data-bind="visible: active && visible, dxMutationObserver: keyboardHelper">
        ...
        <div class="dxrd-preview-search-tab-header">
            <span class="dxrd-preview-search-tab-header-text dxrd-right-panel-header dxd-text-primary" data-bind="text: headerText"></span>
...
<script type="text/html" id="dxrd-preview-parameters">
    <div class="dxrd-preview-parameters-wrapper dxrd-preview-property-wrapper" data-bind="visible: active && visible">
        <div class="dxrd-right-panel-header dxd-text-primary">
            <span data-bind="text: model.headerText"></span>
        ...
        <div class="dxrd-right-panel-body" id="propertiesPanel" data-bind="dxScrollView: { showScrollbar: 'onHover', useNative: false, scrollByThumb: true, onInitialized: function(e) { e.component.option('useKeyboard', false); } }, dxValidationGroup: {}, dxMutationObserver: keyboardHelper">
            ...
            <div class="dxrd-preview-parameter-actions-container">
                ...
                <div class="dxrd-preview-parameter-action dxrdp-parameters-reset dx-accessibility-focus-border-accented" data-bind="dxButton: model.resetButton"></div>
                <div class="dxrd-preview-parameter-action dxrdp-parameters-submit dx-accessibility-focus-border-accented" data-bind="dxButton: model.submitButton"></div>
            </div>
        </div>
        <!-- /ko -->
    </div>
    ...
    <div class="dxrd-preview-pager dxrd-toolbar-item" data-bind="visible: visible">
        <div class="dx-accessibility-toolbar-item dx-accessibility-focus-border-accented" >
            <div class="dxrd-preview-pager-selectbox" data-bind="dxSelectBox: {
                ...
                onKeyUp: widget.onKeyUp, itemTemplate: widget.itemTemplate,
...
<script type="text/html" id="dxrdp-surface">
    <div class="dxrd-preview-wrapper" data-bind="textCopier, css: { 'dx-rtl': rtlReport, 'dxrp-editing-fields-hightlighted': editingFieldsHighlighted } ">
        ...
        <div class="dxrd-preview-surface" data-bind="dxMutationObserver: previewBrickKeyboardHelper">
            ...
            <div class="dxrd-report-preview-holder" role="list">
                <!-- ko with: currentPage -->
                <!-- ko if: pageLoading || (!pageLoading && displayImageSrc) -->
                <div role="listitem" class="dxrd-report-preview dx-accessibility-page-item dx-accessibility-border-accented" data-bind="autoFit: autoFitOptions, styleunit: { width: width, height: height }">
    ...
    <div id="clipboard-container" class="dxrd-position-absolute dxrd-top--100px"><textarea disabled data-bind="attr: { 'aria-label': $root.getLocalization('Clipboard', 'ASPxReportsStringId.WebDocumentViewer_AriaClipboard') }" id="clipboard"></textarea></div>
</script>
...
<script type="text/html" id="dxrd-export-tool">
    ...
    <div class="dxrv-daterange-editor">
        <div data-bind="cacheElement: { action: cacheElement }, dxEllipsisEditor: { value: displayValue, readOnly:true, inputAttr: { 'aria-label': $parent.displayName, id: _editorInputId }, openOnFieldClick: true, buttonAction: function() { showPopup(); } }"></div>
                ...
                <div class="dx-field" data-bind="attr: { 
                    ...
                    css: {
                        ...
                        <div class="dx-field-label dxrd-group-label dxd-back-secondary dx-accordion-header dxd-text-primary" data-bind="styleunit: padding, css: {
                            ...
                            <!-- ko if: !isComplexEditor -->
                            <!-- ko if: !!$data.textToSearch -->
                            <label class="propertygrid-editor-displayName" data-bind="searchHighlighting: { text: displayName, textToSearch: textToSearch }, attr: { 'title': displayName, 'for': editorInputId }, css: { 'dx-field-label-required': isRequired }, style: { fontWeight: isPropertyModified ? 'Bold' : ''}"></label>
                            <!-- /ko -->
                            <!-- ko ifnot: !!$data.textToSearch -->
                            <label class="propertygrid-editor-displayName" data-bind="text: displayName, attr: { 'title': displayName, for: editorInputId }, css: { 'dx-property-required': isRequired }, style: { fontWeight: isPropertyModified ? 'Bold' : ''}"></label>
                            <!-- /ko -->
                            <!-- /ko -->
                    </div>
                    <div class="dx-field-value" data-bind="css: { 'dxd-border-accented': $data.isPropertyHighlighted }">
...
<script type="text/html" id="dxcd-color-undo">
    <div data-bind="dxColorBox: { value: generateValue($root.undoEngine), onValueChanged: onValueChanged, editAlphaChannel: true, popupPosition: { collision: 'flipfit flipfit' }, disabled: disabled, dropDownOptions: { container: $root.getPopupContainer($element) } }"></div>
</script>
...
<div class="dxrd-table-control dxrd-context-menu-container" data-bind="visible: isSelected() && !(selected() || focused()), styleunit: position">
    ...
    <!-- /ko -->
    <!-- ko foreach: rows -->
    <div class="dxrd-table-row-control" data-bind="visible: isSelected(), css: { 'dxrd-selected dxrd-context-menu-container': selected, 'dxrd-focused': focused, 'dxrd-locked': locked }, resizable: { starting: $root.resizeHandler.starting, stopped: $root.resizeHandler.stopped, handles: 'n,s', disabled: !(selected() || focused()), zoom: $root.surface().zoom }, styleunit: { 'top': position.top, 'height': position.height }">
        <div class="dxd-border-accented dxrd-control-border-box"></div>
        ...
        <!-- ko foreach: cells -->
        <div class="dxrd-table-cell-control" data-bind="trackCursor: underCursor, event: { dblclick: function() { $root.inlineTextEdit.show($element) } }, visible: isSelected, css: { 'dxrd-selected dxrd-context-menu-container': selected, 'dxrd-focused': focused, 'dxrd-intersect': isIntersect, 'dxrd-locked': locked, 'dxrd-table-cell-over-rowSpan': rowSpan() === 0  }, resizable: { starting: $root.resizeHandler.starting, stopped: $root.resizeHandler.stopped, handles: 'e,w', disabled: !(selected() || focused()), zoom: $root.surface().zoom, snapHelper: $root.resizeHandler.snapHelper }, styleunit: { 'left': position.left, 'width': position.width, 'height': heightWithRowSpan }, style : { 'z-index': offsetZIndex() }">
            <div class="dxd-border-accented dxrd-control-border-box"></div>
            <!-- ko if: $root.inlineTextEdit.visible() && selected() -->
            <!-- ko with: $root.inlineTextEdit-->
            <div class="inline-text-edit" data-bind="dxTextArea: { value: text, onKeyUp: keypressAction, valueChangeEvent: 'keyup' }"></div>
...
<script type="text/html" id="dxrd-expression-editor-addon">
    <div class="dxrd-editormenu-box dxd-property-grid-menu-box-color dxrd-editor-box-image" data-bind="cacheElement: { action: function() { $data.cacheFunction($root.activateExpressionEditor); } }, dxclick: function(_, element) { showPopup(_, element) }, attr: { title: hint }, css: editorMenuButtonCss">
        <div class="dxrd-editor-box-image-content" data-bind="template: { name: $data.imageTemplateName, if: ko.unwrap($data.imageTemplateName) }"></div>
    </div>
    ...
    <div class="dxrd-editor dxrd-formatting-rule-collection-editor" data-bind="visible: visible, styleunit: { 'marginLeft' : padding }">
        <div data-bind="dxCollectionEditor: options">
            <div data-bind="dxdAccordion: { collapsed: collapsed }">
                ...
                <div class="dx-accordion-content dxd-back-primary">
                    <div data-bind="dxPropertyGrid: { target: value, editorsInfo: { editors: $root.dx._static.formattingRuleSerializationsInfo }, level: level + 1, parentDisabled: editor.disabled }"></div>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/html" id="dxrd-watermarks">
    <div class="dxrd-editor" data-bind="visible: visible">
        <div data-bind="dxCollectionEditor: { values: value, displayName: $root.getLocalization(displayName), level: level, info: info, addHandler: function() { return $root.watermarks().createWatermark(); } }">
        </div>
    </div>
</script>
...
<script type="text/html" id="dxrd-parameters">
    <div class="dxrd-editor" data-bind="visible: visible">
        <div data-bind="dxCollectionEditor: { values: value, displayName: displayName, level: level, info: info, addHandler: function() { return $root.parameters().add(); }, removeHandler: function(parameter) { return $root.parameters().remove(parameter); }, undoEngine: $root.undoEngine }">
        </div>
    </div>
</script>
