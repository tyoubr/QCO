...
.dxrd-preview.dxrd-designer-wrapper .dxrd-preview-parameters-wrapper .dxrd-right-panel-content .dxrd-parameters-group.dxrd-parameters-horizontal .dxrd-parameters-fieldset .dx-fill-available {
  width: -webkit-fill-available;
  width: -moz-available;
}
.dxrd-preview.dxrd-designer-wrapper .dxrd-preview-parameters-wrapper .dxrd-right-panel-content .dxrd-parameters-group.dxrd-parameters-horizontal .dxrd-parameters-fieldset .dx-display-content {
  display: contents;
}
...
.dx-designer .dx-report-viewer.dx-accessibility .dx-colorbox-color-result-preview{
  left:0.8125rem;
}
.dx-rtl .dx-designer .dx-report-viewer.dx-accessibility .dx-colorbox-color-result-preview{
  right:0.8125rem;
}
.dx-designer .dx-report-viewer.dx-accessibility .dx-texteditor.dx-invalid .dx-texteditor-input-container::after{
  right:0.25rem;
}
.dx-rtl .dx-designer .dx-report-viewer.dx-accessibility .dx-texteditor.dx-invalid .dx-texteditor-input-container::after{
  left:0.25rem;
}
.dx-rtl .dx-designer .dx-report-viewer.dx-accessibility .dx-tag-remove-button,
.dx-rtl .dx-designer .dx-report-viewer.dx-accessibility .dx-menu-base .dx-menu-item .dx-menu-item-content .dx-menu-item-popout-container{
  left:0rem;
}
.dx-designer .dx-report-viewer.dx-accessibility .dx-tag-remove-button::after{
  right:0.3125rem;
}
.dx-rtl .dx-designer .dx-report-viewer.dx-accessibility .dx-tag-remove-button::after{
  left:0.3125rem;
}
.dx-designer .dx-report-viewer.dx-accessibility .dx-tag-remove-button::before{
  right:0.5625rem;
}
.dx-rtl .dx-designer .dx-report-viewer.dx-accessibility .dx-tag-remove-button::before{
  left:0.5625rem;
}
