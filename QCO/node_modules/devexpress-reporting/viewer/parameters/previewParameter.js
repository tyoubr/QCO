...
export class PreviewParameter extends BaseModel {
    ...
    validateAndAssignValue(value) {
        ...
        if (!this.isRange) {
            var validator = new PreviewParameterValueValidator();
    ...
    initialize(value, parameterHelper) {
        ...
        if (this.isMultiValueWithLookUp) {
            ...
            var multiValuesHelper = new MultiValuesHelper(this);
            var newItems;
    ...
    serialize() {
        ...
        var value = this.isMultiValueWithLookUp ? this._value : this.value;
        if (this.allowNull) {
