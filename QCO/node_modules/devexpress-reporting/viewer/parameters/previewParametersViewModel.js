...
import { PropertyGridKeyboardHelper, ajax } from '@devexpress/analytics-core/analytics-internal-native';
...
export class PreviewParametersViewModel extends ParameterPanelItemBase {
    ...
    _setParameterValue(parameter, value) {
        var descriptor = parameter.getParameterDescriptor();
        if (descriptor.multiValue) {
            ...
            if (descriptor.hasLookUpValues) {
                ...
                var parameterValues = this.parameterHelper.createMultiValueArray(value, parameter);
    ...
    setParameterValue(parameterName, value) {
        var parameter = this._parameters.filter(x => x.path === parameterName)[0];
        if (!parameter)
