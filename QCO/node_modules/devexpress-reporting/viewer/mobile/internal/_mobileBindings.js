...
export function initializeSlideBinding(element, options) {
    var isStarted = false;
    var processor = new EventProcessor(element, options);
...
export function initializeMobileSearchBinding(element, viewModel) {
    ...
    var $element = $dx(element);
    element.style.display = 'none';
    var $searchText = $element.find('.dxrdp-taptosearch-text');
    var searchBarModel = new SearchBarModel(model, element, $searchText);
