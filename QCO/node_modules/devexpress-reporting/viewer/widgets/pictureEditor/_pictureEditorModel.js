...
export class PictureEditorModel extends BaseRenderingModel {
    constructor(editingFieldModel, element, onResize) {
        ...
        this._getPopupContent = () => {
            var popupInstance = dxPopup['getInstance'](this.$element.find(this.ACTIVE_POPUP_CLASS).element);
    ...
    _addEvents() {
        ...
        this._pointerUpHandler = (e) => {
            ...
            var isEditorContainer = this.$element.is(e.target) || this.$element.has(e.target)
