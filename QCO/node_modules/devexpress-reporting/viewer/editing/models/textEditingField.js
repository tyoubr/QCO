...
export class TextEditingFieldViewModel extends TextEditingFieldViewModelBase {
    constructor(field, pageWidth, pageHeight, page, bounds) {
        ...
        var cssCalculator = new CssCalculator(style, !!brickStyle.rtlLayout);
        ...
        var editorOptions = extend(true, {}, (editor === null || editor === void 0 ? void 0 : editor.options) || {});
...
export function focusTextElement(target) {
    var element = $dx(target).find('input:visible').element || $dx(target).find('textarea:visible').element;
    if (!element)
        return;
