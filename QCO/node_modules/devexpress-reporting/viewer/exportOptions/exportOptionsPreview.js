...
export class ExportOptionsPreview extends ExportOptions {
    ...
    getInfo() {
        return [
            { propertyName: 'csv', modelName: 'Csv', displayName: 'CSV Export Options', localizationId: 'DevExpress.XtraPrinting.CsvExportOptions', from: this._generateFromFunction(CsvExportOptionsPreview), toJsonObject: CsvExportOptionsPreview.toJson, editor: editorTemplates.getEditor('objecteditor') },
            ...
            { propertyName: 'textExportOptions', modelName: 'Text', displayName: 'Text Export Options', localizationId: 'DevExpress.XtraPrinting.TextExportOptions', from: this._generateFromFunction(TextExportOptions), toJsonObject: TextExportOptions.toJson, editor: editorTemplates.getEditor('objecteditor') },
