...
var textArea = { propertyName: 'text', modelName: '@Text', displayName: 'Text', localizationId: 'DevExpress.XtraReports.UI.XRControl.Text', localizable: true, defaultVal: '', editor: editorTemplates.getEditor('stringArray') };
...
export var emptyChartText = { propertyName: 'emptyChartText', modelName: 'EmptyChartText', displayName: 'Empty Chart Text', info: emptyChartTextSerializationsInfo, editor: editorTemplates.getEditor('objecteditor'), type: ChartComponentModelWithText };
export var smallChartText = { propertyName: 'smallChartText', modelName: 'SmallChartText', displayName: 'Small Chart Text', info: emptyChartTextSerializationsInfo, editor: editorTemplates.getEditor('objecteditor'), type: ChartComponentModelWithText };
...
var legendTitleSerializationsInfo = [font18, margin, tag, visibility].concat(titleSerializationsInfo);
var legendTitle = extend(true, {}, title, { info: legendTitleSerializationsInfo });
export var legendSerializationsInfo = [textColor, backColor, direction, alignmentVertical, alignmentHorizontal, visibility, markerMode, markerOffset, legendTitle, border, margin, padding, font8];
