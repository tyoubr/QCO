...
var axisTitleSerializationsInfo = [antialiasing, axisTitleVisibility, font12].concat(titleSerializationsInfo), axisTitle = extend(true, {}, title, { propertyName: 'axisTitle', info: axisTitleSerializationsInfo });
...
export var showAxisLabel = { propertyName: 'showAxisLabel', modelName: '@ShowAxisLabel', displayName: 'Show Axis Label', localizationId: 'DevExpress.XtraCharts.Strip.ShowAxisLabel', editor: editorTemplates.getEditor('bool'), from: parseBool }, axisLabelText = { propertyName: 'axisLabelText', modelName: '@AxisLabelText', displayName: 'Axis Label Text', localizationId: 'DevExpress.XtraCharts.Strip.AxisLabelText', localizable: true, editor: editorTemplates.getEditor('text') };
...
var constantLineTitleSerializationsInfo = [antialiasing, visibility, font8, tag].concat(titleSerializationsInfo), constantLineTitle = extend(true, {}, title, { info: constantLineTitleSerializationsInfo });
export var constantLineSerializationsInfo = [axisValueSerializable, axisValue, name, visible, color, showInLegend, legendName, legendText, showBehind, tag, constantLineTitle];
