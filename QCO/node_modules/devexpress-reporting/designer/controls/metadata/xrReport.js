...
export var watermarkId = { propertyName: 'watermarkId', modelName: '@WatermarkId', displayName: 'WatermarkId', localizationId: 'DevExpress.XtraReports.UI.XtraReport.WatermarkId', editor: editorTemplates.getEditor('text') };
...
export var useLandscape = { propertyName: 'useLandscape', modelName: '@UseLandscape', displayName: 'Use Landscape', localizationId: 'DevExpress.XtraPrinting.PrinterSettingsUsing.UseLandscape', defaultVal: false, from: parseBool, editor: editorTemplates.getEditor('bool') };
export var usePaperKind = { propertyName: 'usePaperKind', modelName: '@UsePaperKind', displayName: 'Use Paper Kind', localizationId: 'DevExpress.XtraPrinting.PrinterSettingsUsing.UsePaperKind', defaultVal: false, from: parseBool, editor: editorTemplates.getEditor('bool') };
export var defaultPrinterSettingsUsingInfo = {
