...
export var defaultCodeSerializationInfo = { propertyName: 'name', modelName: '@Name' };
...
var fnc2Substitute = { propertyName: 'fNC2Substitute', modelName: '@FNC2Substitute', defaultVal: '', editor: editorTemplates.getEditor('text'), displayName: 'FNC2 Functional Character', localizationId: 'DevExpress.XtraPrinting.BarCode.DataBarGenerator.FNC2Substitute' };
var fnc3Substitute = { propertyName: 'fNC3Substitute', modelName: '@FNC3Substitute', defaultVal: '', editor: editorTemplates.getEditor('text'), displayName: 'FNC3 Functional Character', localizationId: 'DevExpress.XtraPrinting.BarCode.DataBarGenerator.FNC3Substitute' };
var fnc4Substitute = { propertyName: 'fNC4Substitute', modelName: '@FNC4Substitute', defaultVal: '', editor: editorTemplates.getEditor('text'), displayName: 'FNC4 Functional Character', localizationId: 'DevExpress.XtraPrinting.BarCode.DataBarGenerator.FNC4Substitute' };
var code128SerializationInfo = [
    defaultCodeSerializationInfo,
    addLeadingZero,
    charset,
    fnc1Substitute,
...
var fnc1SubstituteWithSharp = Object.assign(Object.assign({}, fnc1Substitute), { defaultVal: '#' });
...
var frameOptions = { propertyName: 'frameOptions', modelName: 'FrameOptions' };
var frameOptionsFake = {
...
var QRCodeGS1SerializationInfo = [
    defaultCodeSerializationInfo,
    fnc1SubstituteWithSharp,
    compactionMode,
    errorCorrectionLevel,
...
var FrameOptionsFakeEPC = extend({}, frameOptionsFake, { valuesArray: FrameOptionsTypesEPC });
var QRCodeEPCSerializationInfo = [
    defaultCodeSerializationInfo,
    frameOptions,
    FrameOptionsFakeEPC,
    includeQuietZone,
