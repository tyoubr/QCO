    ...
    constructor(report, zoom = ko.observable(1)) {
        ...
        this._assignSelectedWatermark = () => {
            ...
            this._watermarkSubscriptions.push(this._watermarkTextRenderingResult = ko.pureComputed(() => {
                ...
                var originalWidthPx = unitsToPixel(this.report.pageWidth(), this.measureUnit());
                var originalHeightPx = unitsToPixel(this.report.pageHeight(), this.measureUnit());
                ...
                var font = new CssCalculator(this.watermark, ko.observable(false)).fontCss();
        ...
        this.surfaceContextMenuHandler = (selection, surface, e) => {
            ...
            if (target.className === 'dxrd-band-marker-content')
                return;
            var focused = selection.focused && selection.focused();
            if (!focused)
                return;
