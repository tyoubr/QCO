    ...
    constructor(rootITems, listPropertyNames, member, getPathByMember) {
        ...
        this.getItems = (pathRequest) => {
            ...
            if (!pathRequest.fullPath) {
                ...
                var dataMembers = this.getObjectPropertiesForPath(ko.unwrap(target.model), pathRequest.fullPath, target.name);
                dataMembers = dataMembers.map(dataMember => { dataMember.cssRule = { ['dxrd-context-menu-container']: !!target.hasContextMenu }; return dataMember; });
