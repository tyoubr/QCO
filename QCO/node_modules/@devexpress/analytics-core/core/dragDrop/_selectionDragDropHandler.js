...
export class SelectionDragDropHandler extends DragDropHandler {
    ...
    doStopDrag(uiElement, _) {
        ...
        if (this.selection.dropTarget) {
            ...
            const focusedSurface = this.selection.focused();
            let adjustedTarget = this.adjustDropTarget(dropTargetSurface), focusedModel = focusedSurface.getControlModel(), parent = focusedModel.getNearestParent(adjustedTarget.getControlModel());
