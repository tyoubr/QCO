...
export class NativeModelSerializer {
    ...
    serializeProperty(modelPropertyInfo, viewModel, serializationsInfo, refs, result) {
        let propertyName = modelPropertyInfo.propertyName, value = this.unwrapPropertyValue('_' + propertyName in viewModel ? viewModel['_' + propertyName] : viewModel[propertyName]), defaultVal = modelPropertyInfo.defaultVal;
