...
export class TreeListItemViewModel extends BaseRenderingModel {
    ...
    _getCssRules() {
        var _a;
        var cssRule = { 'dx-treelist-item-selected dxd-state-selected dxrd-fieldslist-context-menu-container': this.isSelected || this.isMultiSelected };
            ...
            value.done((data) => {
                ...
                _data.forEach((d, index) => {
                    ...
                    if (!currentItem) {
                        ...
                        newItem.visible && (this.visibleItemsCount += 1);
    ...
    _getChildViewModels() {
        let items = this.visibleItems || this.items;
