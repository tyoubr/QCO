...
addToBindingsCache('dxPopover: { container: $root.getPopupContainer($element), target: target, position: \'bottom\', showCloseButton: false, onHidden: onHidden, hideEvent: \'mouseleave focusout\', hideOnOutsideClick: true, hideOnParentScroll: true, width: \'350px\', visible: visible }', function ($context, $element) { return { 'dxPopover': function () { return { 'container': $context.$root.getPopupContainer($element), 'target': $context.$data.target, 'position': 'bottom', 'showCloseButton': false, 'onHidden': $context.$data.onHidden, 'hideEvent': 'mouseleave focusout', 'hideOnOutsideClick': true, 'hideOnParentScroll': true, 'width': '350px', 'visible': $context.$data.visible }; } }; });
...
addToBindingsCache('dxAction: { action: function(s) { $data.click(); }}, css: css.class, attr: { title: text, \'aria-label\': text, \'aria-expanded\': active }, visible: visible', function ($context, $element) { return { 'dxAction': function () { return { 'action': function (s) { $context.$data.click(); } }; }, 'css': function () { return $context.$data.css.class; }, 'attr': function () { return { 'title': $context.$data.text, 'aria-label': $context.$data.text, 'aria-expanded': $context.$data.active }; }, 'visible': function () { return $context.$data.visible; } }; });
...
addToBindingsCache('if: !isComplexEditor', function ($context, $element) { return { 'if': function () { return !$context.$data.isComplexEditor; } }; });
addToBindingsCache('if: $data.description', function ($context, $element) { return { 'if': function () { return $context.$data.description; } }; });
...
addToBindingsCache('click: function(s, e) { $root.hideContextMenu && $root.hideContextMenu(); toggleSelected(s, e); }, event: $root.ContextMenusEnabled && $root.ContextMenusEnabled() ? { contextmenu: toggleSelected } : null, draggable: dragDropHandler', function ($context, $element) { return { 'click': function () { return function (s, e) { $context.$root.hideContextMenu && $context.$root.hideContextMenu(); $context.$data.toggleSelected(s, e); }; }, 'event': function () { return $context.$root.ContextMenusEnabled && $context.$root.ContextMenusEnabled() ? { 'contextmenu': $context.$data.toggleSelected } : null; }, 'draggable': function () { return $context.$data.dragDropHandler; } }; });
addToBindingsCache('click: function(s, e) { $root.hideContextMenu && $root.hideContextMenu(); toggleSelected(s, e); }, event: $root.ContextMenusEnabled && $root.ContextMenusEnabled() ? { contextmenu: toggleSelected } : null', function ($context, $element) { return { 'click': function () { return function (s, e) { $context.$root.hideContextMenu && $context.$root.hideContextMenu(); $context.$data.toggleSelected(s, e); }; }, 'event': function () { return $context.$root.ContextMenusEnabled && $context.$root.ContextMenusEnabled() ? { 'contextmenu': $context.$data.toggleSelected } : null; } }; });
