...
declare module DevExpress.Analytics.Utils {
    ...
    export interface IAction {
        ...
        setImageTemplateNameChangedEvent?: (callback: (newValue: string) => void) => () => void;
        setImageClassNameChangedEvent?: (callback: (newValue: string) => void) => () => void;
        disabled?: Observable<boolean> | Computed<boolean>;
        getDisabled?: () => boolean;
        setDisabledChangedEvent?: (callback: (newValue: boolean) => void) => () => void;
        visible?: Observable<boolean> | Computed<boolean> | boolean;
        getVisible?: () => boolean;
        setVisibleChangedEvent?: (callback: (newValue: boolean) => void) => () => void;
        selected?: Observable<boolean> | Computed<boolean> | boolean;
        setSelectedChangedEvent?: (callback: (newValue: boolean) => void) => () => void;
        zoom?: Subscribable<number> | number;
        zoomStep?: Subscribable<number>;
        zoomLevels?: Subscribable<number[]> | number[];
        setZoomLevelsChangedEvent?: (callback: (newValue: number[]) => void) => () => void;
        setZoom?: (newValue: number) => void;
        setZoomChangedEvent?: (callback: (newValue: number) => void) => () => void;
    }
...
declare module DevExpress.Analytics.Internal {
    ...
    export class ActionListsBase extends BaseRenderingModel<DevExpress.Analytics.Internal.IActionListBaseViewModel> implements IShortcutActionList {
        ...
        subscribe(property: Subscribable | any, callback: (newValue?: any) => void, valueChangedEventSetter?: (callback: (newValue?: any) => void) => () => void): void;
        _isActionDisabled(action: DevExpress.Analytics.Utils.IAction): boolean;
        _isActionVisible(action: DevExpress.Analytics.Utils.IAction): boolean;
    ...
    type Options = {
        ...
        target?: string;
        getClickAtionParams?: () => any;
        contextMenusEnabled: ko.Observable<boolean>;
    };
    export class ContextMenuProvider extends Disposable {
        constructor({ actions, target, getClickAtionParams, contextMenusEnabled }: Options);
        hide(): void;
    ...
    export let ajax: (...params: (IAjaxSettings | any)[]) => any;
...
declare module DevExpress.Analytics.Widgets.Internal {
    ...
    type CustomTextBoxType = CustomDxTextBoxOptions<DevExpress.ui.dxTextBox.TextBoxInstance>;
...
declare module DevExpress.Analytics.Serializer.Native {
    ...
    export type ViewModelGenerator<T> = {
        ...
        generateProperty<K extends keyof T>(propertyName: K, value?: T[K], setter?: (newVal: T[K]) => void): ViewModelGenerator<T>;
        configureProperty<K extends keyof T>(propertyName: K, configure: (property: T[K]) => void): ViewModelGenerator<T>;
        getViewModel(): T;
    };
    export let createViewModelGenerator: <T>(_viewModel?: Partial<T>) => ViewModelGenerator<T>;
    export function setDefaultViewModelGenerator(modelGenerator: <T>() => ViewModelGenerator<T>): void;
    ...
    export let defaultPropertyDeserializatonEngine: PropertyDeserializationEngine;
...
declare module DevExpress.Analytics.Widgets {
    ...
    export class Editor extends BaseRenderingMultiplatformModel<DevExpress.Analytics.Widgets.IEditorViewModel> {
        ...
        private _validator;
        dispose(): void;
        constructor(modelPropertyInfo: DevExpress.Analytics.Utils.ISerializationInfo, level: any, parentDisabled?: any, textToSearch?: any, popupService?: DevExpress.Analytics.Internal.PopupService, engineType?: DevExpress.Analytics.Serializer.Native.EngineType);
    ...
    export class PropertyGridEditor extends Editor {
        private _popupService?;
        createViewModel(): DevExpress.Analytics.Widgets.IEditorViewModel;
        constructor(info: DevExpress.Analytics.Utils.ISerializationInfo, level: any, parentDisabled?: ko.Computed<boolean>, textToSearch?: any, _popupService?: DevExpress.Analytics.Internal.PopupService, engineType?: DevExpress.Analytics.Serializer.Native.EngineType);
    ...
    export class BooleanEditor extends Editor {
        constructor(info: DevExpress.Analytics.Utils.ISerializationInfo, level: any, parentDisabled?: ko.Computed<boolean>, textToSearch?: any, popupService?: DevExpress.Analytics.Internal.PopupService, engineType?: DevExpress.Analytics.Serializer.Native.EngineType);
...
declare module DevExpress.QueryBuilder.Internal {
    ...
    export class ColumnExpressionCollectionHelper {
        ...
        static createNew(query: DevExpress.QueryBuilder.Elements.QueryViewModelBase, collection: ko.ObservableArray<DevExpress.QueryBuilder.Elements.ColumnExpression>, table: string, column: string): DevExpress.QueryBuilder.Elements.ColumnExpression;
